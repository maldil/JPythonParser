...
public class PythonParser extends Parser {
	...
	public final PythonParser.dotted_name_return dotted_name() throws RecognitionException {
		...
		try {
			...
			if ( state.backtracking==0 ) {
			        retval.names = actions.makeDottedName(NAME147, list_dn);
			    }
			}
	...
	public final PythonParser.global_stmt_return global_stmt() throws RecognitionException {
		...
		try {
			...
			if ( state.backtracking==0 ) {
			          stype = new Global(GLOBAL149, actions.makeNames(list_n), actions.makeNameNodes(list_n));
			      }
			}
	...
	public final PythonParser.nonlocal_stmt_return nonlocal_stmt() throws RecognitionException {
		...
		try {
			...
			if ( state.backtracking==0 ) {
			          stype = new Nonlocal(NONLOCAL151, actions.makeNames(list_n), actions.makeNameNodes(list_n));
			      }
			}
		...
		try {
			...
			switch (alt88) {
				case 1 :
					...
					if ( state.backtracking==0 ) {
					            stype = actions.makeTryExcept(TRY191, (trysuite!=null?((PythonParser.suite_return)trysuite).stypes:null), list_e, (elsesuite!=null?((PythonParser.suite_return)elsesuite).stypes:null), (finalsuite!=null?((PythonParser.suite_return)finalsuite).stypes:null));
					        }
					}
					break;
				case 2 :
	...
	public final PythonParser.with_stmt_return with_stmt() throws RecognitionException {
		...
		try {
			...
			if ( state.backtracking==0 ) {
			        ...
			        stype = actions.makeWith(WITH199, list_w, (suite202!=null?((PythonParser.suite_return)suite202).stypes:null));
			    }
			}
