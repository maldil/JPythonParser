...
import astnodes.ast.Suite;
import astnodes.base.mod;
import heart.CodeBootstrap;
import heart.CodeFlag;
import heart.CodeLoader;
...
import heart.PyFunctionTable;
import heart.PyInteger;
import heart.PyLong;
import heart.PyObject;
import heart.PyRunnable;
import heart.PyRunnableBootstrap;
...
public class Module implements Opcodes, ClassConstants, CompilationContext {
    ...
    public Module(String name, String filename, boolean linenumbers) {
        this(name, filename, linenumbers, heart.imp.NO_MTIME);
    }
    ...
    public Module(String name) {
        this(name, name + ".py", true, heart.imp.NO_MTIME);
    }
