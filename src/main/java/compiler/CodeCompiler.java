...
import astnodes.Visitor;
import astnodes.ast.*;
import astnodes.base.expr;
import astnodes.base.mod;
import astnodes.base.stmt;
import heart.AsyncContextGuard;
import heart.AsyncContextManager;
import heart.AsyncIterator;
import heart.CompareOp;
import heart.CompilerFlags;
import heart.ContextGuard;
import heart.ContextManager;
import heart.PyCoroutine;
import heart.PyGenerator;
import heart.imp;
import heart.Py;
import heart.PyCode;
...
import heart.PyFrame;
import heart.PyFunction;
import heart.PyInteger;
import heart.PyList;
import heart.PyLong;
import heart.PyObject;
import heart.PySet;
import heart.PySlice;
...
import static util.CodegenUtils.*;
...
public class CodeCompiler extends Visitor implements Opcodes, ClassConstants {
    ...
    final static Method contextGuard_getManager =
            Method.getMethod("heart.ContextManager getManager (heart.PyObject)");
    final static Method __enter__ =
            Method.getMethod("heart.PyObject __enter__ (heart.ThreadState)");
    final static Method __exit__ =
            Method.getMethod("boolean __exit__ (heart.ThreadState,heart.PyException)");
    /*
    ...
    @Override
    public Object visitModule(astnodes.ast.Module suite) throws Exception {
