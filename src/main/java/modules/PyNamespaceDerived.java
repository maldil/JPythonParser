...
public class PyNamespaceDerived extends PyNamespace implements Slotted,FinalizablePyObjectDerived,TraverseprocDerived {
    ...
    public PyNamespaceDerived(PyType subtype) {
        super(subtype);
