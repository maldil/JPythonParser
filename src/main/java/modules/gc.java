 ...
 * introduction of a traverseproc-mechanism (c.f. {@link heart.Traverseproc})
 ...
 * {@link heart.finalization.FinalizeTrigger}s, Jython has full control about
...
public class gc {
     ...
     * {@link heart.Traverseproc} and
     * are not marked as {@link heart.Untraversable}.
     ...
     * that neither implements {@link heart.Traverseproc}
     * nor is marked as {@link heart.Untraversable} (even if
     ...
     * {@link heart.Traverseproc},
     * nor are annotated with the {@link heart.Untraversable}-annotation.
     * </p>
     * <p>
     ...
     * traversed that neither implements {@link heart.Traverseproc},
     * nor is annotated with the {@link heart.Untraversable}-annotation.
     *
     * @see #setJythonGCFlags(short)
     * @see #getJythonGCFlags()
     * @see #addJythonGCFlags(short)
    ...
    /**
     * Works like {@link heart.Py#writeDebug(String, String)},
     * but prints to {@link heart.Py#writeDebug(String, String)}
     ...
     * @see heart.Py#writeDebug(String, String)
     */
...
//--------------Finalization preprocess/postprocess section--------------------
     ...
     * {@link heart.finalization.FinalizeTrigger}s;
...
//--------------end of Monitoring section--------------------------------------
     ...
     * Suppress warnings for PyObjects that neither implement {@link heart.Traverseproc} nor
     * are marked as {@link heart.Untraversable}.<br>
     * {@link #USE_PY_WRITE_DEBUG} - uses {@link heart.Py#writeDebug(String, String)} for
     ...
     * {@link heart.finalization.FinalizeTrigger}.
     */
     ...
     * Throws {@link heart.Py#NotImplementedError}.
     *
     * @throws heart.Py.NotImplementedError
     */
    ...
    */
    ...
    /**
     * Does its best to traverse the given {@link heart.PyObject}
     * {@code ob}. It exploits both
     * {@link heart.Traverseproc#traverse(Visitproc, Object)} and
     * {@link heart.TraverseprocDerived#traverseDerived(Visitproc, Object)}.
     * If {@code ob} neither implements {@link heart.Traverseproc} nor
     * {@link heart.Traverseproc} and is not annotated with
     * {@link heart.Untraversable}, reflection-based traversion via
     * {@link #traverseByReflection(Object, Visitproc, Object)} may be attempted
     * according to {@link #DONT_TRAVERSE_BY_REFLECTION}.
     *
     * @see heart.Traverseproc#traverse(Visitproc, Object)
     * @see heart.TraverseprocDerived#traverseDerived(Visitproc, Object)
     * @see #DONT_TRAVERSE_BY_REFLECTION
     * @see heart.Untraversable
            ...
            if (! (ob instanceof Traverseproc || ob instanceof TraverseprocDerived ||
                ...
                if (((gcFlags & INSTANCE_TRAVERSE_BY_REFLECTION_WARNING) != 0) ||
                    ...
                    Py.writeWarning("gc", "The PyObject-subclass "+ob.getClass().getName()+"\n" +
                            ...
                            "javadoc of heart.Traverseproc.java.");
                }
            }
        }
...
//--------------Visitproc section----------------------------------------------
    ...
    private static class ReferentsFinder implements Visitproc {
        ...
        public int visit(PyObject object, Object arg) {
            ((heart.PySequenceList) arg).pyadd(object);
            return 0;
        }
    }
    ...
    private static class ReferrerFinder implements Visitproc {
        ...
        public int visit(PyObject object, Object arg) {
            if (((PyObject[]) arg)[0].__eq__(object).__bool__()) {
                ((heart.PySequenceList) ((PyObject[]) arg)[1]).pyadd(object);
            }
            return 0;
        }
    }
