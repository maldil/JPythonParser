...
public class GlobalRef extends WeakReference<PyObject> {
     ...
     *
     * @param object a {@link heart.PyObject} to reference
     ...
     * {@link AbstractReference}s. The
     * current {@code GlobalRef} is disbanded.
     * If the given {@link heart.PyObject} is not the former
     ...
     * {@link heart.PyObject}.
     *
     * @param object a {@link heart.PyObject}
     * @return a {@link heart.PyList} of references. May be empty.
     */
