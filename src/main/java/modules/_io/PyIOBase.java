...
import heart.BufferProtocol;
import heart.Py;
import heart.PyArray;
import heart.PyBUF;
import heart.PyBuffer;
import heart.PyByteArray;
...
import heart.buffer.SimpleStringBuffer;
 ...
 * <code>_fileio.PyFileIO</code>, the purely Java-accessible {@link heart.io.IOBase} (both
 * Philip Jenvey's work), and the Python implementation in <code>Lib/_pyio</code>. We do not simply
 * delegate to the implementation in {@link heart.io} because of the need to override
