...
public class FormattedValueDerived extends FormattedValue implements Slotted,FinalizablePyObjectDerived,TraverseprocDerived {
    ...
    public FormattedValueDerived(PyType subtype) {
        super(subtype);
