...
public class AsyncWithDerived extends AsyncWith implements Slotted,FinalizablePyObjectDerived,TraverseprocDerived {
    ...
    public AsyncWithDerived(PyType subtype) {
        super(subtype);
