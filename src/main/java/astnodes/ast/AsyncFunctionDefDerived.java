/* Generated file on 08/09/2020, 22:26:18, do not modify.  /gen_templates/gderived.py. */
...
public class AsyncFunctionDefDerived extends AsyncFunctionDef implements Slotted,FinalizablePyObjectDerived,TraverseprocDerived {
    ...
    public AsyncFunctionDefDerived(PyType subtype) {
        super(subtype);
