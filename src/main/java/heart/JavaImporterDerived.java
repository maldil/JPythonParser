...
public class JavaImporterDerived extends JavaImporter implements Slotted,FinalizablePyObjectDerived,TraverseprocDerived {
    ...
    public JavaImporterDerived(PyType subtype) {
        super(subtype);
