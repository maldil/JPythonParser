...
/**
 * This is used like {@link heart.Traverseproc},
 * but traverses only the {@code slots[]}-array of
 * {@code fooDerived}-classes. This way we avoid that the traverse
 * method of a traversable {@link heart.PyObject} is
 * overwritten by the derived version.
 * {@link modules.gc#traverse(PyObject, Visitproc, Object)} takes care of
