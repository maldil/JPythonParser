 ...
 * can be attached to arbitrary {@link heart.PyObject}s.
 ...
 * to attach
 * {@link modules._weakref.GlobalRef}-objects in the
 * {@link modules._weakref.WeakrefModule}.
 * </p>
 * <p>
...
public abstract class JyAttribute implements Serializable {
    ...
    */
     ...
     * weakrefs (i.e. {@link modules._weakref.AbstractReference})
    ...
    /**
     * Allows the id of a {@link heart.PyObject} to persist
    ...
    /**
     * Checks whether the given {@link heart.PyObject}
