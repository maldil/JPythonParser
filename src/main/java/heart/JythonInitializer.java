...
/**
 * A service for initializing Jython without explicitly calling {@link PySystemState}. If
 * a file META-INF/services/heart.JythonInitializer is on the classpath, Jython will
...
public interface JythonInitializer {
    ...
    /**
     * Called from {@link PySystemState} with the full set of initialization arguments.
