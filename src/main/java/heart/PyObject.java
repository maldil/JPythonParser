...
import heart.stringlib.IntegerFormatter;
import heart.stringlib.InternalFormat;
import exposers.ExposedClassMethod;
import exposers.ExposedDelete;
...
public class PyObject implements Serializable {
     ...
     *
     * @see heart.JyAttribute
     * @see heart.JyAttribute#JAVA_PROXY_ATTR
     * @see #getJavaProxy()
     */
     ...
     * documentation of {@link heart.finalization.FinalizablePyObject}.
     * </p>
     * <p>
...
//        return (PyUnicode) invoke("__repr__");
     ...
     * <code>heart.finalization.HasFinalizeTrigger</code>
    ...
    **/
     ...
     * @see heart.PyObject#__coerce_ex__(heart.PyObject)
     **/
