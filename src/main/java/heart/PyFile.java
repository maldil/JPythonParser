...
import heart.finalization.FinalizableBuiltin;
import heart.finalization.FinalizeTrigger;
import heart.io.BinaryIOWrapper;
import heart.io.BufferedIOBase;
import heart.io.BufferedRandom;
import heart.io.BufferedReader;
import heart.io.BufferedWriter;
import heart.io.FileIO;
import heart.io.IOBase;
import heart.io.LineBufferedRandom;
import heart.io.LineBufferedWriter;
import heart.io.RawIOBase;
import heart.io.StreamIO;
import heart.io.TextIOBase;
import heart.io.TextIOWrapper;
import heart.io.UniversalIOWrapper;
import heart.stringlib.Encoding;
...
public class PyFile extends PyObject implements FinalizableBuiltin, Traverseproc {
     ...
     * {@link heart.util.FileUtil#wrap(InputStream, String, int)}
     * {@link heart.util.FileUtil#wrap(InputStream, String)}
     * {@link heart.util.FileUtil#wrap(InputStream, int)}
     * {@link heart.util.FileUtil#wrap(InputStream)}
     */
     ...
     * {@link heart.util.FileUtil#wrap(OutputStream, String, int)}
     * {@link heart.util.FileUtil#wrap(OutputStream, String)}
     * {@link heart.util.FileUtil#wrap(OutputStream, int)}
     * {@link heart.util.FileUtil#wrap(OutputStream)}
     */
