 ...
 * tracefunc in {@link heart.PyFrame}).
 ...
 * recommended to be annotated {@link heart.Untraversable}.
 * </p>
 * <p>
 ...
 * gc behaviors. See also {@link modules.gc} for more details on this.
 * </p>
 * <p>
 ...
 * classes is traversed by {@link heart.TraverseProcDerived}.
 ...
 * {@link modules.gc#traverse(PyObject, Visitproc, Object)} rather
 * than directly calling methods in this interface.
 * </p>
 * <p>
 * Also note that {@link heart.PyObject#objtype} is not subject to
 ...
 * {@link heart.PyObject#objtype} is actually
 ...
 * {@link heart.Visitproc}. If {@code Object}s or {@code interface}-types are
 ...
 * {@link heart.PyException} and {@link }.
 ...
 * {@link modules.gc#traverseByReflection(Object, Visitproc, Object)}.
 * This is for instance used in {@link heart.PyArray}.
 * </p>
 * <p>
 * <br>
 * <b>Examples</b><br><br>
 ...
 * {@link heart.PySet}. It extends {@link heart.BaseSet},
 ...
 * {@link heart.Untraversable}. {@link heart.PyInteger} is
 ...
 * let it implement {@link heart.Traverseproc}.
 * Write {@link heart.Traverseproc#traverse(Visitproc, Object)} by
 ...
 * {@link heart.Visitproc#visit(PyObject, Object)} returns non-zero,
 * return the result immediately (i.e. abort the traverse process).
 * The following example is taken from
 * {@link heart.PyMethod}:<br><br>
 * <pre>
 ...
 *  }
 * </pre>
 * Implement {@link heart.Traverseproc#refersDirectlyTo(PyObject)}
 ...
 * {@link heart.Visitproc#visit(PyObject, Object)} returns non-zero.
 * The following example is taken from {@link heart.BaseSet}:<br><br>
 * <pre>
 *  /{@literal *} Traverseproc implementation {@literal *}/
 *  {@literal @}Override
 *  public int traverse(Visitproc visit, Object arg) {
 ...
 *  }
 * </pre>
 * In this case, {@link heart.Traverseproc#refersDirectlyTo(PyObject)}
 ...
 *  }
 * </pre>
 * In contrast to that, {@link heart.Traverseproc#refersDirectlyTo(PyObject)}
 ...
 * {@link modules.gc#canLinkToPyObject(Class, boolean)} can help to safe
 ...
 * offers a way to let {@link heart.Traverseproc#refersDirectlyTo(PyObject)}
 ...
 * <br>
 * modules._jythonlib:<br>
 *   dict_builder                    - Traverseproc<br>
 * <br>
 * modules._threading:<br>
 ...
 * @see heart.Visitproc
 * @see modules.gc#traverse(PyObject, Visitproc, Object)
 * @see modules.gc#traverseByReflection(Object, Visitproc, Object)
 * @see modules.gc#canLinkToPyObject(Class, boolean)
 */
