...
class EmitVisitor(asdl.VisitorBase):
    ...
    def open(self, package, name, refersToPythonTree=1, useDataOutput=0):
        ...
        print("// Autogenerated AST node on "+ datetime.now().strftime("%m/%d/%Y, %H:%M:%S") , file=self.file)
        print('package astnodes.%s;' % package, file=self.file)
        if refersToPythonTree:
            print('import org.antlr.runtime.CommonToken;', file=self.file)
            print('import org.antlr.runtime.Token;', file=self.file)
            print('import astnodes.AST;', file=self.file)
            print('import astnodes.PythonTree;', file=self.file)
            print('import astnodes.adapter.AstAdapters;', file=self.file)
            print('import astnodes.base.excepthandler;',file=self.file)
            print('import astnodes.base.expr;', file=self.file)
            print('import astnodes.base.mod;', file=self.file)
            print('import astnodes.base.slice;',file=self.file)
            print('import astnodes.base.stmt;', file=self.file)
            print('import heart.ArgParser;', file=self.file)
            print('import heart.AstList;', file=self.file)
            print('import heart.Py;', file=self.file)
            print('import heart.PyObject;', file=self.file)
            print('import heart.PyUnicode;', file=self.file)
            print('import heart.PyStringMap;', file=self.file)
            print('import heart.PyType;',file=self.file)
            print('import heart.Visitproc;', file=self.file)
            print('import exposers.ExposedGet;', file=self.file)
            print('import exposers.ExposedMethod;', file=self.file)
            print('import exposers.ExposedNew;', file=self.file)
            print('import exposers.ExposedSet;', file=self.file)
            print('import exposers.ExposedType;',file=self.file)
...
class JavaVisitor(EmitVisitor):
    ...
    def simple_sum(self, sum, name, depth):
        ...
        self.emit('import astnodes.AST;', depth)
        self.emit('', 0)
    ...
    def simple_sum_wrappers(self, sum, name, depth):
        for i in range(len(sum.types)):
            ...
            self.emit('import astnodes.AST;', depth)
            self.emit('import astnodes.base.%s;' % name, depth)
            self.emit('import astnodes.PythonTree;', depth)
            self.emit('import heart.Py;', depth)
            self.emit('import heart.PyObject;', depth)
            self.emit('import heart.PyUnicode;', depth)
            self.emit('import heart.PyType;', depth)
            self.emit('import exposers.ExposedGet;', depth)
            self.emit('import exposers.ExposedMethod;', depth)
            self.emit('import exposers.ExposedNew;', depth)
            self.emit('import exposers.ExposedSet;', depth)
            self.emit('import exposers.ExposedType;', depth)
            self.emit('', 0)
...
if __name__ == "__main__":
    ...
    OUT_DIR = '../../src/main/java/astnodes/'
    try:
